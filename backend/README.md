...
## Project Structure
    ...
    ├── samp_comp_analytics_44319  # Django project configurations
...
1. Clone this repo and `cd samp_comp_analytics_44319`
...
2. Clone this repo and `cd samp_comp_analytics_44319`
